...
with open('data/reiners_modeltwo_residuals.csv') as f:
    cf = csv.reader(f)
...
with open('data/reiners_modelone_residuals.csv') as f:
    cf = csv.reader(f)
...
with open('data/reiners_modelone_residuals_new.csv') as f:
    cf = csv.reader(f)
    time_residuals_new1 = []
    residual_new1 = []
    for row in cf:
...
with open('data/reiners_flux_data.csv') as f:
    cf = csv.reader(f)
    time_flux_model1 = []
    flux_model1 = []
    for row in cf:
...
# axs[1].set_xlabel("Time (UTC)")
# axs[1].set_ylabel("Residuals")
# plt.savefig("rm_and_residuals_new_cb.png")
# plt.show()
