...
grass_data_no_cb = h5py.File("data/neid_all_lines_rv_off_SSD_gpu_fine_spectra_1.jld2", "r")
lines_no_cb = grass_data_no_cb["name"][()]
GRASS_no_cb  = grass_data_no_cb["rv"][()]
grass_data_no_cb2 = h5py.File("data/neid_all_lines_rv_off_SSD_gpu_fine_spectra_2.jld2", "r")
