...
# #measure velocities
# v_grid_cpu, ccf_cpu = EchelleCCFs.calc_ccf(lambdas_cpu, outspec_cpu, spec)
# rvs_cpu, sigs_cpu = EchelleCCFs.calc_rvs_from_ccf(v_grid_cpu, ccf_cpu)

#To Do
#ask for NEID RV without BC cause pipeline could be different BC
#make separate files for eclipse stuff that is different from original GRASS