...
#model
file = h5py.File("data/300_model_data.jld2", "r")
...
#line by line data
line_data = h5py.File("data/300_neid_RVlinebyline.jld2", "r")
...
for i in [5]:
    ...
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.savefig("300_with_old_extinction/rm_and_residuals_{}.png".format(lines[i]))
    #plt.show()
    plt.clf()
    ...
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.savefig("300_with_old_extinction/rm_and_residuals_cb_{}.png".format(lines[i]))
    #plt.show()
    plt.clf()