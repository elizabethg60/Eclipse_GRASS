...
#read in data
#GRASS
grass_data = h5py.File("data/neid_all_lines_rv_regular_Kostogryz_LD_SSD.jld2", "r")
lines = grass_data["name"][()]
GRASS_rv  = grass_data["rv"][()]
rv_error_GRASS_cb  = grass_data["rv_error"][()]
grass_data_no_cb = h5py.File("data/neid_all_lines_rv_off_Kostogryz_LD_SSD.jld2", "r")
lines_no_cb = grass_data_no_cb["name"][()]
GRASS_no_cb  = grass_data_no_cb["rv"][()]
rv_error_GRASS_no_cb = grass_data_no_cb["rv_error"][()]
#model
file = h5py.File("data/model_data_Kostogryz_LD_SSD.jld2", "r")
...
#line by line data
line_data = h5py.File("data/neid_RVlinebyline_Kostogryz_LD_SSD.jld2", "r")
