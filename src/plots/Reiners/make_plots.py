...
axs[0].scatter(time, raw_rv, color = 'k', marker = "x", s = 15, label = "Reiners RVs")
axs[0].plot(time, RV_list_no_cb, color = 'r', label = "Model - No CB")
axs[0].xaxis.set_major_formatter(mdates.DateFormatter("%H:%M"))
axs[0].set_xlabel("Time (UTC)")
axs[0].set_ylabel("RV [m/s]")
axs[0].legend()
#residuals
axs[1].scatter(time, raw_rv - RV_list_no_cb, color = 'r', marker = "x", s = 1)
...
axs[0].legend()
#residuals
axs[1].scatter(time, raw_rv - RV_list_cb, color = 'r', marker = "x", s = 1)
axs[1].xaxis.set_major_formatter(mdates.DateFormatter("%H:%M"))
axs[1].set_xlabel("Time (UTC)")
axs[1].set_ylabel("Residuals")
