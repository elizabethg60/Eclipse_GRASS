...
axs[0].scatter(time, raw_rv, color = 'r', marker = "x", s = 5, label = "Reiners corrected RVs")
axs[0].scatter(time, RV_list_no_cb,  color = 'k', s = 5, label = "Model - No CB")
# axs[0].scatter(time, RV_list_cb, color = 'grey', s = 5, label = "Model - CB")
...
#residuals
axs[1].scatter(time, raw_rv - RV_list_no_cb, color = 'k', marker = "x", s = 1)
# axs[1].scatter(time, raw_rv - RV_list_cb, color = 'grey', marker = "x", s = 1)
axs[1].scatter(time_residuals_model1, residual_model1, color = 'red', marker = "x", s = 1)
