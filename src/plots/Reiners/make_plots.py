...
axs[0].scatter(UTC_time, raw_rv, color = 'k', marker = "x", s = 15, label = "Reiners RVs")
...
axs[0].legend()
#residuals
axs[1].scatter(UTC_time, raw_rv - RV_list_no_cb, color = 'r', marker = "x", s = 1)
...
#rm curve
linear_slope = (raw_rv[46]-raw_rv[0])/46
fig, axs = plt.subplots(2, sharex=True, sharey=False, gridspec_kw={'hspace': 0, 'height_ratios': [3, 1]})
axs[0].scatter(UTC_time[0:46], (raw_rv[0:46] / (linear_slope*range(0,46)+raw_rv[0])) + RV_list_cb[0:46], color = 'k', marker = "x", s = 15)
...
axs[0].legend()
#residuals
axs[1].scatter(UTC_time[0:46], ((raw_rv[0:46] / (linear_slope*range(0,46)+raw_rv[0])) + RV_list_cb[0:46]) - RV_list_cb[0:46], color = 'r', marker = "x", s = 1)
...
axs[0].legend()
#residuals
axs[1].scatter(UTC_time, raw_rv - RV_list_cb_new, color = 'r', marker = "x", s = 1)
axs[1].scatter(time_residuals_model2, residual_model2, color = 'k', marker = "x", s = 1)
axs[1].xaxis.set_major_formatter(mdates.DateFormatter("%H:%M"))
axs[1].set_xlabel("Time (UTC)")
axs[1].set_ylabel("Residuals")
