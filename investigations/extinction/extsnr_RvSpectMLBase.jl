...
jldopen("/storage/home/efg5335/work/Eclipse_GRASS/figures/NEID_October/SSD_4Parameter/LD/data/projected_SSD_4parameter_gpu.jld2", "r") do file
...
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/no_ext/flux_comp_SSD.png")
plt.clf()
...
ax1.set_xlabel("airmass")
ax1.set_ylabel("relative flux ratio") 
ax1.axvline(x = airmass[49])
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/no_ext/coeff_eclipse_SSD.png")
plt.clf()
...
ax1.set_xlabel("airmass")
ax1.set_ylabel("relative flux difference") 
ax1.axvline(x = airmass[49])
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/no_ext/flux_comp_diff_SSD.png")
plt.clf()
...
grass_intensity_array = nothing
jldopen("/storage/home/efg5335/work/Eclipse_GRASS/figures/NEID_October/SSD_4Parameter/LD_Ext/data/projected_SSD_4parameter_gpu_ext.jld2", "r") do file
    global grass_intensity_array
    grass_intensity_array = (file["intensity"])
end
...
ax1.set_ylabel("relative flux & intensity") 
ax1.axvline(x = airmass[49])
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/ext/flux_comp_SSD.png")
plt.clf()
...
ax1.set_ylabel("relative flux ratio") 
ax1.axvline(x = airmass[49])
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/ext/coeff_eclipse_SSD.png")
plt.clf()
...
ax1.set_ylabel("relative flux difference") 
ax1.axvline(x = airmass[49])
plt.savefig("/storage/home/efg5335/work/Eclipse_GRASS/investigations/extinction/ext/flux_comp_diff_SSD.png")
plt.clf()